  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0f', fontFamily: "'Poppins', sans-serif", padding: '2rem' }}>
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        {msg && <p style={{ color: msg.startsWith('❌') ? '#ff4444' : '#4caf50', marginBottom: '1rem', fontSize: '14px' }}>{msg}</p>}
        ...
        {tab === 'movies' && (
          <div style={{ background: '#0f0f1a', borderRadius: '16px', padding: '1.5rem', border: '1px solid #1a1a2e' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
              ...
              <input style={inputStyle} placeholder="Lien Google Drive vidéo" value={form.video_url} onChange={e => setForm(f => ({ ...f, video_url: e.target.value }))} />
            </div>
            ...
            <div style={{ marginBottom: '10px' }}>
              <p style={{ color: '#aaa', fontSize: '13px', marginBottom: '6px' }}>📸 Affiche du film :</p>
              <input type="file" accept="image/*" onChange={e => handleUploadCover(e, null)}
                style={{ color: '#aaa', fontSize: '13px' }} />
              {form.cover_url && <img src={form.cover_url} alt="" style={{ width: '80px', borderRadius: '8px', marginTop: '8px' }} />}
            </div>
